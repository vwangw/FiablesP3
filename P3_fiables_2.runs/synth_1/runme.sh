...
HD_PWD='C:/Users/Vicente/P3_fiables_2/P3_fiables_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log redundancia.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source redundancia.tcl
