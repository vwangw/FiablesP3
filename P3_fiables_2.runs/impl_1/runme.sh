...
HD_PWD='C:/Users/Vicente/P3_fiables_2/P3_fiables_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log redundancia.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source redundancia.tcl -notrace
